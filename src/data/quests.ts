...
export const QUEST_POOL: readonly Quest[] = [
  ...
  { id: 'q-herb', domain: 'medicine', grade: 'menial', title: '약초 채집 동행', client: '마을 의원', preview: '하루 약초꾼을 따라 산을 돈다.', weeks: 1, days: 1, reward: { money: 8, fame: 1 }, recommended: 1, minStat: 0 },
  // ── 소무 ──
