...
// 흑화 창 = 어둠으로의 회귀 — 살수 본능을 다시 쥐는 선택(6·9·11·15) + 적대·고립·위로 부재로 마음이 다시 식는 선택(3·12·13)에 darkness:+1.
//   (docs/48 카탈로그 근거: y3 흑화=적대 누적 · y12 흑화=진실 가속 · y13 흑화=위로 부재.)
...
export const I_CHEONGHA_ARC: ArcEvent[] = [
  ...
  // ─── 정착기 (자기 화해·하산) ───
  {
    ...
    year: 13,
    title: '마주침(直面)',
    body: '덮어 둘 수 없는 진실이 문턱까지 왔다. 한 동문이 오래전 이청하의 옛 손에 잃은 사람을 똑똑히 기억하고 있다는 것. 요즈음 아이가 부쩍 옛 꿈에 시달린다. "사부님… 자꾸, 안 좋은 꿈을 꿔요. 무슨 일이 오려는 걸까요." 사부가 결정해야 한다. 아이에게 진실을 알릴 것인가. 알게 된다면 이청하는 분명 무너질 것이다.',
    choices: [
