...
export interface PerpetratorEffect {
  ...
  personalityShift?: Partial<PersonalityTraits>;  // 성격 미세 조정
...
export interface CascadeEffect {
  ...
  triggerCondition?: {
    ...
    personality?: Partial<PersonalityTraits>;        // 성격 조건 (각 축 ≥ 임계)
    forbidPersonality?: Partial<PersonalityTraits>;  // 각 축 ≤ 임계
  };
...
export interface MoralEventTrigger {
  ...
  requirePersonality?: Partial<PersonalityTraits>;  // 각 축 ≥ 임계
  forbidPersonality?: Partial<PersonalityTraits>;   // 각 축 ≤ 임계
